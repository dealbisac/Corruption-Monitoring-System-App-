...
import 'package:khalticlone/src/utils/oval-right-clipper.dart';
...
class Navigation extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _key,
      appBar: AppBar(
        title: Text('Corruption Monitoring System'),
  ...
  Widget _buildRow(IconData icon, String title, {bool showBadge = false, Null Function() onPressed, Null Function() onTap}) {
